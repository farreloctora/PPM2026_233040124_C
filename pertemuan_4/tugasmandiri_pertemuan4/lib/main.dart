...
class _HomePageState extends State<HomePage> {
  ...
  final List<Catatan> _catatan = [
    ...
    Catatan(
      ...
      isi: 'Kerjakan soal sorting dan searching dari buku bab 5.',
      kategori: 'Tugas',
      emailPengirim: 'dosen@kampus.ac.id',
  ...
  // === TUGAS 1: Buka halaman Edit ===
  Future<void> _bukaEditCatatan(Catatan catatan, int indexAsli) async {
    final hasil = await Navigator.pushNamed(context, '/edit', arguments: catatan);

    if (hasil is Catatan) {
      setState(() => _catatan[indexAsli] = hasil);
      ...
      body: Container(
        ...
        child: tampil.isEmpty
          ...
          itemBuilder: (context, i) {
            final c = tampil[i];
            // Cari index asli di _catatan (untuk keperluan delete & edit)
            ...
            return ListTile(
              ...
              onTap: () async {
                ...
                // Tangkap hasil edit yang dikirim dari DetailCatatanPage
                if (hasil is Map && hasil['action'] == 'edit') {
                  _bukaEditCatatan(
                      hasil['catatan'] as Catatan, hasil['index'] as int);
                }
              },
            );
          },
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Kirim sinyal ke HomePage untuk membuka halaman edit
              Navigator.pop(context, {'action': 'edit', 'catatan': catatan, 'index': index});
            },
          ),
        ],
      ),
